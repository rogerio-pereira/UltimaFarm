...
<div class='col-md-6 margin-top'>
    <div class="input-group">
        <span class="input-group-addon" id="commission">Comissão (em %)</span>
        {!! Form::input('number', 'commission', null, ['class' => 'form-control', 'aria-describedby' => 'commission', 'min' => 1, 'step' => 0.01]) !!}
    </div>
</div>
