...
class ClientRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'user.password' => 'required|same:user.confirmation',
    ...
    public function messages()
    {
        return [
            ...
            'user.password.same' => 'O campo "Senha" deve ser igual ao campo "Confirmação de senha"',

            'user.confirmation.required' => 'O campo "Confirmação de Senha" é obrigatório',
